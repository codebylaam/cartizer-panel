...
/**
 * cartizer theme — built by `bunx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { cartizerTheme } from './cartizer';
 *   import './cartizer.css';
 */
export const cartizerTheme = {
  name: 'cartizer',
  __built: true,
  tokens: {
    ...
    "--font-family-body": "Figtree, Noto Sans Bengali",
    "--font-family-heading": "Alice, Noto Serif Bengali",
